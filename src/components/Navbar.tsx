    ...
    <nav className="sticky top-0 z-40 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md no-print" ref={dropdownRef}>
      <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between">
        <div className="flex items-center gap-8">
          <div className="flex flex-col cursor-pointer" onClick={() => onViewChange(isAdmin ? 'admin_all_history' : 'history')}>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="text-right hidden sm:block">
            ...
            <p className="text-[10px] font-medium text-slate-400 uppercase tracking-wider mt-1">{user.Unit}</p>
          </div>

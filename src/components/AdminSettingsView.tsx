  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="bg-slate-900 p-8 rounded-[2.5rem] text-white">
        ...
        <div className="bg-white/10 p-8 rounded-3xl border border-white/10 text-slate-200 text-center" style={{ fontSize: 'clamp(1rem, 2.5vw, 1.5rem)', fontFamily: "'Plus Jakarta Sans', sans-serif" }}>

            ...
            <div className="bg-slate-900 px-6 py-5">
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  } bg-blue-600 hover:bg-blue-500 text-white font-black py-4 rounded-2xl text-[10px] uppercase tracking-[0.2em] transition-all shadow-lg flex items-center justify-center gap-2`}
                >
                  {loading && <Loader2 className="animate-spin" size={16} />}
                  {isEditing ? 'UPDATE PESANAN' : 'KIRIM PESANAN'}
                </button>
              </div>
            </div>
          )}

        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left min-w-[600px]">
            <thead className="bg-slate-50 border-b border-slate-100">
              <tr>
                <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase">Nama Barang</th>
                <th className="px-6 py-4 text-[9px] font-black text-slate-400 uppercase">Vendor</th>
              ...
              {filteredBarang.length === 0 ? (
                ...
                filteredBarang.map((b, idx) => (
                  <tr key={b.id || b.iddetil || `master-${idx}`} className="hover:bg-slate-50 transition-colors">
                    <td className="px-6 py-4 text-[10px] font-black uppercase italic">{b.NamaBarang}</td>
                    <td className="px-6 py-4 text-[9px] font-medium text-slate-500">{b.Vendor || '-'}</td>
                    <td className="px-6 py-4 text-right text-[10px] font-black text-blue-600">
